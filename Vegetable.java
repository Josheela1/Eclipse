...
public class Vegetable {
	...
	public Vegetable(String name,boolean type,String[] color,int quantity,String[] ingredients,String shape,String flavour,String texture,int watercontent,int carbohydrates ) {
		this.name=name;
		this.veg=type;
